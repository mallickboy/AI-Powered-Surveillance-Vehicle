...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{powerBank}
        \caption{Power Bank}
        \label{fig:powerBank}
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{powerCircuit}  % Boost Converter Image
        \caption{Boost Converter Circuit}
        \label{fig:powerCircuit}
    \end{minipage} \hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{buckConverter}  % Buck Converter Image
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{base}  % First Image (Base)
        \caption{Chassis}
        \label{fig:base}
    \end{minipage} \hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{bodMotor}  % Second Image (BOD Motor)
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{usbPowerbank}  % First Image (Base)
        \caption{12 V Activator Circuit Diagram for Power Bank}
        \label{fig:base}
    \end{minipage} \hfill
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{circuitDiagram}  % Second Image (BOD Motor)
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{webUI}  % Web User Interface Image
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=5cm, height=5cm]{ui}  % Desktop User Interface Image
